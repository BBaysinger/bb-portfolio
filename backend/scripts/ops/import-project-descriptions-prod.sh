...
cd "${BACKEND_DIR}"
ALLOW_PROD_WRITE=true PROD_WRITE_CONFIRMATION='import-projects-prod' USE_GITHUB_SECRETS=true npm run import:project-descriptions -- --env "${PROFILE}" --confirm-prod-write
