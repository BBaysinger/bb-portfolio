# BB-Portfolio Blue-Green / Promotion Lifecycle
...
- Multi-candidate staging (blue / green / canary tiers).
- Weighted traffic shifting (ALB target groups instead of EIP swap).
...
- 2025-11-14: Initial version capturing promotion + retention integration.
- 2025-11-14: Added cost optimization guidance & workflow toggle for automatic previous instance destroy.
