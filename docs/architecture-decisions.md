...
- **Context:**
  ...
  - On-demand revalidation already invalidated those routes after project, CV, branding-lockup, screenshot, thumbnail, and brand updates.
...
- **Implementation:**
  ...
  - Branding-lockup warms `/`; CV content/logo changes warm `/cv/`; project media/brand changes warm only the related project routes plus home when the homepage can visibly change.
- **Reasoning:**
