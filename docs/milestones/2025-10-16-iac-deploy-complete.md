...
- One orchestrator: `deploy/scripts/full-deployment.sh` handles infra, secrets sync, image builds, and container restarts
...
- `deploy/scripts/full-deployment.sh` (preferred entrypoint)
