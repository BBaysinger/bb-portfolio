 ...
 *
 * Bundles per-environment secrets (via merge-github-secrets.ts) and generates a terraform.tfvars
 * file with the appropriate values, ensuring single source of truth.
 *
 * Usage: npx tsx deploy-lagoon/scripts/generate-terraform-vars.ts [--secrets <path>] [--out <path>]
...
# =============================================================================
# 
# This file is generated by deploy-lagoon/scripts/generate-terraform-vars.ts
# DO NOT EDIT MANUALLY - changes will be overwritten
#
# To update values, edit the relevant .github-secrets.<env>.private.json5 file(s), then run:
# npm run secrets:bundle && npx tsx deploy-lagoon/scripts/generate-terraform-vars.ts
# =============================================================================
...
function main() {
  try {
    console.info(
      "🔄 Generating terraform.tfvars from bundled GitHub secrets...",
    );
