...
function checkPrerequisites() {
  ...
  try {
    ...
    console.error('AWS CLI not found. Please install it and configure your credentials.')
    console.error('See: https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html')
    process.exit(1)
  }
...
function syncCollection(collection: string, environment: Environment, dryRun: boolean) {
