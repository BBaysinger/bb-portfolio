...
async function main() {
  ...
  if (!seedBase) {
    console.error('No seed folder found. Create ../seedings (or ../seeding) next to the repo and place your images inside.')
    process.exit(2)
  }
  ...
  if (grandTotal === 0) {
    console.log('No media imported. Ensure you placed files under the seed folder in one of the supported subpaths.')
  } else {
