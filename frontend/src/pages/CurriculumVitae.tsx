              ...
              <div className={styles["cv-listing"]}>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    functional custom chrome (navigation bars, menus, etc.) and
                    a slot-machine&nbsp;game.
                  </li>
                  <li>
            ...
            <div className={divClassRt}>
              ...
              <div className={styles["cv-listing"]}>
                ...
                <div className={"col-md-12"}>
                  ...
                  the annual Spokane Ad Fed (Addy) Awards, including five
                  Silver, four Gold, two Best of Division, one Best of Show, and
                  one Golden&nbsp;Pixel
                </div>
              </div>
            </div>
